...
const champions = [
  { name: 'Sofia Chen', score: 142, avatar: 'https://api.dicebear.com/9.x/adventurer/svg?seed=Sofia' },
  { name: 'Marcus Johnson', score: 128, avatar: 'https://api.dicebear.com/9.x/adventurer/svg?seed=Marcus' },
  { name: 'Priya Sharma', score: 115, avatar: 'https://api.dicebear.com/9.x/adventurer/svg?seed=Priya' },
];
